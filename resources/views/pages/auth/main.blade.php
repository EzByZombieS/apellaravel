<x-authLayout title="Login">
	<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-size-cover bgi-no-repeat bgi-attachment-fixed" style="background-image: url({{ asset('images/background-login.jpg') }})">
		<!--begin::Content-->
			...
			<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
				...
				<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{ route('home')}}" action="#">
					...
					<div class="text-center mb-10">
						<!--begin::Title-->
						<h1 class="text-dark mb-3">Sign In to APeL</h1>
						<!--end::Title-->
						<!--begin::Link-->
